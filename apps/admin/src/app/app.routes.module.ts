...
import { ReglasDeNegocioComponent } from './pages/reglas-de-negocio/reglas-de-negocio.component';
...
export const appRoutes: Routes = [
  ...
  },
  {
    ...
    data: {
      allowedRoles: [environment.id_groups.admin],
    },
    children: [
      {
      ...
      {
        path: RoutesNames.BUSSINESS_RULES_ROUTE,
        component: ReglasDeNegocioComponent,
      },
      {
